...
function main() {
  ...
  console.log('如需完整档：人力资源月度自查包 · 买断版（SkillPay 商品号 S0806000206862825）—— 本版本未执行的 2 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-hr-monthly-selfcheck-free.mark');

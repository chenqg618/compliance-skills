...
function main() {
  ...
  console.log('如需完整档：版税与授权金结算核对 · 买断版（SkillPay 商品号 S0806000206861571）—— 本版本未执行的 5 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-royalty-settlement-check-free.mark');

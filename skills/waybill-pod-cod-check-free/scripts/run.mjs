...
function main() {
  ...
  console.log('如需完整档：运单回单与代收货款核对 · 买断版（SkillPay 商品号 S0806000206862837）—— 本版本未执行的 5 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-waybill-pod-cod-check-free.mark');

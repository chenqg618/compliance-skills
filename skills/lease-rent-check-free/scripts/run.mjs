...
function main() {
  ...
  console.log('如需完整档：租金账单与押金结算核对 · 买断版（SkillPay 商品号 S0806000206834494）—— 本版本未执行的 5 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-lease-rent-check-free.mark');

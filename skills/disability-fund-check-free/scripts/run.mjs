...
function main() {
  ...
  console.log('如需完整档：残保金申报表：上年在职职工人数与年平均工资、安排残疾人就业人数与比例、应缴金额=（上年在职人数×规定比例−实际安排人数）×上年在职年平均工资、30 人以下免征与分档减缴、已缴与应缴差异发放前核对 · 买断版（SkillPay 商品号 S0806000206845453）—— 本版本未执行的 4 项检查在完整档里都有。');

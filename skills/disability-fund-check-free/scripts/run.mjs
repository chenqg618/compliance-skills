...
function main() {
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-disability-fund-check-free.mark');
  ...
  console.log('如需完整档：残疾人就业保障金申报核对 · 买断版（SkillPay 商品号 S0806000206861584）—— 本版本未执行的 5 项检查在完整档里都有。');

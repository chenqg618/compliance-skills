...
function main() {
  ...
  console.log('如需完整档：出口报关与收汇核销核对 · 买断版（SkillPay 商品号 S0806000206845522）—— 本版本未执行的 5 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-export-fx-collection-check-free.mark');

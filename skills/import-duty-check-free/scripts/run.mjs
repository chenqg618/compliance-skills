...
function main() {
  ...
  console.log('如需完整档：进口税费核算核对 · 买断版（SkillPay 商品号 S0806000206834492）—— 本版本未执行的 4 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-import-duty-check-free.mark');

...
function main() {
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-consignment-settlement-check-free.mark');
  ...
  console.log('如需完整档：寄售代销结算核对 · 买断版（SkillPay 商品号 S0806000206864829）—— 本版本未执行的 5 项检查在完整档里都有。');

...
function main() {
  ...
  console.log('如需完整档：连锁门店调拨与库存核对 · 买断版（SkillPay 商品号 S0806000206854889）—— 本版本未执行的 5 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-store-transfer-check-free.mark');

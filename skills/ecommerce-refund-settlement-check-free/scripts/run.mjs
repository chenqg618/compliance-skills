...
function main() {
  ...
  console.log('如需完整档：电商退货退款与货款结算核对 · 买断版（SkillPay 商品号 S0806000206851304）—— 本版本未执行的 5 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-ecommerce-refund-settlement-check-free.mark');

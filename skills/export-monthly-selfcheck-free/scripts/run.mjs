...
function main() {
  ...
  console.log('如需完整档：外贸月度自查包 · 买断版（SkillPay 商品号 S0806000206853096）—— 本版本未执行的 2 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-export-monthly-selfcheck-free.mark');

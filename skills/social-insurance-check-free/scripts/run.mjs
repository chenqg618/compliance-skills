...
function main() {
  ...
  console.log('如需完整档：社保公积金核对 · 买断版（SkillPay 商品号 S0806000206852987）—— 本版本未执行的 4 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-social-insurance-check-free.mark');

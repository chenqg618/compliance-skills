...
function main() {
  ...
  console.log('如需完整档：商场联营抽成与保底核对 · 买断版（SkillPay 商品号 S0806000206862841）—— 本版本未执行的 5 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-mall-concession-check-free.mark');

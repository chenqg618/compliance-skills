...
function main() {
  ...
  console.log('如需完整档：工资个税累计预扣核对 · 买断版（SkillPay 商品号 S0806000206834493）—— 本版本未执行的 4 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-iit-withholding-check-free.mark');

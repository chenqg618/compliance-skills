...
function main() {
  ...
  console.log('如需完整档：三单匹配AI核对 · 买断版（SkillPay 商品号 S0806000206852982）—— 本版本未执行的 8 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-three-way-match-free.mark');

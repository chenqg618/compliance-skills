...
function main() {
  ...
  console.log('如需完整档：税务月度自查包 · 买断版（SkillPay 商品号 S0806000206862824）—— 本版本未执行的 2 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-tax-monthly-selfcheck-free.mark');

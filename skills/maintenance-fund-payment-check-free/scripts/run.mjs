...
function main() {
  ...
  console.log('如需完整档：维修资金与专项工程付款核对 · 买断版（SkillPay 商品号 S0806000206846739）—— 本版本未执行的 5 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-maintenance-fund-payment-check-free.mark');

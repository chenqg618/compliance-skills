...
function main() {
  ...
  console.log('如需完整档：加工贸易手册与保税料件核对 · 买断版（SkillPay 商品号 S0806000206862839）—— 本版本未执行的 5 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-toll-processing-manual-check-free.mark');

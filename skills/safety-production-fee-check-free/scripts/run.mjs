...
function main() {
  ...
  console.log('如需完整档：安全生产费用提取与使用核对 · 买断版（SkillPay 商品号 S0806000206862838）—— 本版本未执行的 5 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-safety-production-fee-check-free.mark');

...
function main() {
  ...
  console.log('如需完整档：研发费用加计扣除归集核对 · 买断版（SkillPay 商品号 S0806000206832709）—— 本版本未执行的 4 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-rd-expense-check-free.mark');

...
function main() {
  ...
  console.log('如需完整档：门店营收上报核对 · 买断版（SkillPay 商品号 S0806000206836342）—— 本版本未执行的 5 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-store-sales-report-check-free.mark');

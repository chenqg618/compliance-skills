...
function main() {
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-piece-rate-wage-check-free.mark');
  ...
  console.log('如需完整档：计件工资与工序单价核对 · 买断版（SkillPay 商品号 S0806000206862852）—— 本版本未执行的 5 项检查在完整档里都有。');

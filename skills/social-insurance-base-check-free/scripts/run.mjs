...
function main() {
  ...
  console.log('如需完整档：社保公积金缴费基数核对 · 买断版（SkillPay 商品号 S0806000206851256）—— 本版本未执行的 5 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-social-insurance-base-check-free.mark');

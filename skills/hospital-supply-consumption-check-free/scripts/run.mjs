...
function main() {
  ...
  console.log('如需完整档：药品耗材进销存与科室领用核对 · 买断版（SkillPay 商品号 S0806000206862836）—— 本版本未执行的 5 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-hospital-supply-consumption-check-free.mark');

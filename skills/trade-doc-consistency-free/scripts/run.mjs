...
function main() {
  ...
  console.log('如需完整档：外贸单证单单一致核对 · 买断版（SkillPay 商品号 S0806000206851193）—— 本版本未执行的 8 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-trade-doc-consistency-free.mark');

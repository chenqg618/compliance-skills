...
function main() {
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-equipment-maintenance-cost-check-free.mark');
  ...
  console.log('如需完整档：设备维保与备件领用费用核对 · 买断版（SkillPay 商品号 S0806000206862851）—— 本版本未执行的 4 项检查在完整档里都有。');

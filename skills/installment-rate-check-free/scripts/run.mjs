...
function main() {
  ...
  console.log('如需完整档：分期实际年化核对 · 买断版（SkillPay 商品号 S0806000206837916）—— 本版本未执行的 5 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-installment-rate-check-free.mark');

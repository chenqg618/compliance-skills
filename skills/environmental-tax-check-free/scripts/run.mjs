...
function main() {
  ...
  console.log('');
  console.log('本次为【免费版】：已执行全部免费检查项，另有 6 项未执行（见上）。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-environmental-tax-check-free.mark');
  ...
  console.log('如需完整档：环境保护税申报核对 · 买断版（SkillPay 商品号 S0806000206864828）—— 本版本未执行的 6 项检查在完整档里都有。');

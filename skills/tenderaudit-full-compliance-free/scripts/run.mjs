...
function main() {
  ...
  console.log('如需完整档：招投标全案合规审计 · 买断版（SkillPay 商品号 S0806000206851202）—— 本版本未执行的 4 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-tenderaudit-full-compliance-free.mark');

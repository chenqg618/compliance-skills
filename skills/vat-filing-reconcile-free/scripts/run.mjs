...
function main() {
  ...
  console.log('如需完整档：增值税申报与账载开票三方核对 · 买断版（SkillPay 商品号 S0806000206851206）—— 本版本未执行的 5 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-vat-filing-reconcile-free.mark');

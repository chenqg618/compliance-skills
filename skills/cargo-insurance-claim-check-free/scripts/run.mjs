...
function main() {
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-cargo-insurance-claim-check-free.mark');
  ...
  console.log('如需完整档：货运险投保与货损理赔核对 · 买断版（SkillPay 商品号 S0806000206864822）—— 本版本未执行的 5 项检查在完整档里都有。');

...
function main() {
  ...
  console.log('如需完整档：存货报废与审批核对 · 买断版（SkillPay 商品号 S0806000206846700）—— 本版本未执行的 5 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-inventory-scrap-approval-check-free.mark');

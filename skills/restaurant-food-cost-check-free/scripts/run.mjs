...
function main() {
  ...
  console.log('如需完整档：餐饮菜品成本与出品率核对 · 买断版（SkillPay 商品号 S0806000206862831）—— 本版本未执行的 5 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-restaurant-food-cost-check-free.mark');

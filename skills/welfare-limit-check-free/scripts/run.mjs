...
function main() {
  ...
  console.log('如需完整档：职工福利费与教育经费限额核对 · 买断版（SkillPay 商品号 S0806000206846699）—— 本版本未执行的 5 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-welfare-limit-check-free.mark');

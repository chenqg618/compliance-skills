...
function main() {
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-software-license-check-free.mark');
  ...
  console.log('如需完整档：软件许可与云资源费用核对 · 买断版（SkillPay 商品号 S0806000206862856）—— 本版本未执行的 5 项检查在完整档里都有。');

...
function main() {
  ...
  console.log('如需完整档：教培课消与预收学费核对 · 买断版（SkillPay 商品号 S0806000206851321）—— 本版本未执行的 5 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-training-hour-consumption-check-free.mark');

...
function main() {
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-intangible-amortization-check-free.mark');
  ...
  console.log('如需完整档：无形资产摊销与研发资本化核对 · 买断版（SkillPay 商品号 S0806000206862863）—— 本版本未执行的 6 项检查在完整档里都有。');

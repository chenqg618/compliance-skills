...
function main() {
  ...
  console.log('如需完整档：医保结算清单与DRG入组核对 · 买断版（SkillPay 商品号 S0806000206862840）—— 本版本未执行的 5 项检查在完整档里都有。');
  ...
  try {
    ...
    const mark = pathx.join(os.tmpdir(), 'skillpay-choice-drg-settlement-check-free.mark');
